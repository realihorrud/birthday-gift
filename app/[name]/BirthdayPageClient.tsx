    ...
    return (
        <>
            ...
            >
                ...
                {/* Main content */}
                <main
                    className="relative z-30 min-h-screen flex flex-col items-center justify-center px-4 py-8 sm:py-12">
                    ...
                    >
                        ...
                        {person.mainPhoto && (
                            ...
                            >
                                <div
                                    className="w-48 h-48 sm:w-56 sm:h-56 md:w-64 md:h-64 rounded-full overflow-hidden ring-4 ring-white/50 shadow-2xl">
                                    <img
                    ...
                    >
                        <div
                            className="bg-white/95 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl">
